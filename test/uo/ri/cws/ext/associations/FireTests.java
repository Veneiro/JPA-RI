...
//		Mechanic m = om.get();
//		assertTrue(m._getTerminatedContracts().contains(contract));
...
//
//		assertFalse(m._getTerminatedContracts().contains(contract));
//		assertTrue(contract.getFiredMechanic().isEmpty());
//	}
//
//	@Test
//	public void testSafeReturn() {
//		Set<Contract> contracts = mechanic._getTerminatedContracts();
...
//				mechanic._getTerminatedContracts().contains(contract));
//	}
//
//}
